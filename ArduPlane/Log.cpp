...
struct PACKED log_Rangefinder_State {
    LOG_PACKET_HEADER;
    uint64_t time_us;
    bool in_range:1;
...
void Plane::Log_Write_Rangefinder_State()
{
    struct log_Rangefinder_State pkt = {
...
// @Field: InRng: The initial measured reange
...
// @Field: Dst: The last recorded distance
    { LOG_RFNS_MSG, sizeof(log_Rangefinder_State),
